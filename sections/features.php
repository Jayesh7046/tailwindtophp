    ...
    <section id="features">
        ...
        <div class="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
            ...
            <div class="flex flex-col space-y-12 md:w-1/2">
                ...
                <p class="max-w-sm pt-10 text-center hover:text-orange-900 md:text-left">
                    Manage provide all functionality your team needs,
                    without the
            ...
            <div class="flex flex-col space-y-8 md:w-1/2">
                ...
                <div class="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                    ...
                    <!-- Heading -->
                    <div class="rounded-l-full bg-orange-300 md:bg-transparent">
                        <div class="flex items-center space-x-2">
                            <div class="px-4 py-2 text-white rounded-full md:py-1 bg-orange-600">
                                01
                            </div>
